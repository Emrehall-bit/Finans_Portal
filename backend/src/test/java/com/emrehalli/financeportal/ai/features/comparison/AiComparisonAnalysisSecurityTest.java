...
import com.emrehalli.financeportal.ai.features.comparison.AiComparisonAnalysisController;
    ...
    void setUp() throws Exception {
        ...
        when(comparisonAnalysisService.getComparisonAnalysis("THYAO", "PGSUS"))
                .thenReturn(new ComparisonAnalysisResponse(
                        ...
                        AiResponseMetadata.fromAiResponse(new com.emrehalli.financeportal.ai.core.provider.AiResponse("{}", com.emrehalli.financeportal.ai.core.provider.AiProviderType.GROQ, false, "llama", 1L), DataQuality.PARTIAL.name())
                ));
    }
