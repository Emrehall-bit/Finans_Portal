package com.emrehalli.financeportal.technicalanalysis.scheduler;
...
import com.emrehalli.financeportal.technicalanalysis.service.PortfolioAlertIntegrationService;
import com.emrehalli.financeportal.technicalanalysis.repository.ChartDrawingRepository;
        ...
        linkedDrawings.forEach(d -> {
            try {
                portfolioAlertIntegrationService.syncDrawingWithAlert(
                        (com.emrehalli.financeportal.technicalanalysis.entity.ChartDrawing) d);
            } catch (Exception e) {
