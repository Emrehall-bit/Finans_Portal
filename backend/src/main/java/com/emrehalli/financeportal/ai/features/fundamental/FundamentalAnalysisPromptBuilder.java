...
public class FundamentalAnalysisPromptBuilder implements AiPromptBuilder {
    ...
    public String build(String symbol,
        ...
        return AiPromptBuilder.languageInstruction(language) + """
                ...
                Sinyalleri birebir tekrar etme; sentezle ve birleştir.
                ...
                2. strengths: 2-3 madde - şirketin içsel güçlü dinamikleri; gerekirse bir sayı kullan ama asıl amaç anlamı açıklamak
                3. weaknesses: 1-2 madde - şirket içindeki zayıf noktalar
                4. risks: 1-2 madde - bilanço kırılganlığı, dış faktörler veya sürdürülebilirlik belirsizliği; strengths/weaknesses ile tekrar etme
