...
@Tag(name = "Admin - Denetim Loglari", description = "Yonetici islem denetim kayitlari")
public class AdminAuditLogController {
    ...
    @Operation(summary = "Denetim loglarini listele", description = "Sayfalanmis ve filtrelenebilir denetim log kayitlarini getirir")
    @ApiResponses(@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Denetim loglari basariyla listelendi"))
    @GetMapping
