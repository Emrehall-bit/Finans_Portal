package com.emrehalli.financeportal.notification.repository;
...
public interface NotificationReadRepository extends JpaRepository<NotificationRead, Long> {
    ...
    @Query("""
            select count(n)
            from Notification n
            where n.targetType = com.emrehalli.financeportal.notification.enums.NotificationTargetType.BROADCAST
              and not exists (
                select 1
                from NotificationRead nr
