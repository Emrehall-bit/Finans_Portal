package com.emrehalli.financeportal.analysis.scheduler;
...
import com.emrehalli.financeportal.analysis.service.PortfolioAlertIntegrationService;
        ...
        linkedDrawings.forEach(d -> {
            try {
                portfolioAlertIntegrationService.syncDrawingWithAlert(
                        (com.emrehalli.financeportal.analysis.entity.ChartDrawing) d);
            } catch (Exception e) {
